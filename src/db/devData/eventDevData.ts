...
export const eventDevData: EventInput[] = [
  {
    ...
    description:
      'Start your day with a relaxing group yoga session in the park.',
  ...
  },
  {
    ...
    description:
      'Meet professionals and recruiters from the local tech industry.',
  ...
  },
  {
    ...
    description:
      'Sample and purchase goods from local food artisans and chefs.',
  ...
  },
  {
    ...
    description: 'A hands-on introduction to programming for all ages.',
  ...
  },
  {
    ...
    description: 'Join fellow enthusiasts for a guided city photo walk.',
  ...
  },
  {
    ...
    description: 'Experts discuss practical steps for greener living.',
    location: 'Greenhouse Community Center',
    price: 0.0,
  ...
  },
  {
    ...
    description:
      'Bring your family for an outdoor screening of a classic film.',
  ...
  },
  {
    ...
    description: 'Celebrate the season with crafts, food, and music.',
